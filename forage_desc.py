...
class Forage_desc(Frame):
    def __init__(self):
        ...
        Creat_btn = Button( CoordFrame, text="Créer",cursor="hand2", font=("Times new roman",12, "bold"), bd=0, bg="silver", fg="black", relief=SUNKEN)
        Creat_btn.grid(sticky=W, padx=15, pady=2)

        Abort_btn = Button( CoordFrame, text="Annuler",cursor="hand2", font=("Times new roman",12, "bold"), bd=0, bg="silver", fg="black", relief=SUNKEN)
