...
##########################################Ruyigi###############################################################
   ...
   ###############################################Fonction Province#####################################################         
        ...
        Param_frame.place(x=405, y=115, width=400, height=460)
        ...
        Param_frame2 = Frame(Param_frame, bd=5, relief=GROOVE, bg="white",width=315,height=400)
        ...
        txt_Param_frame2.place(x=0, y = 0,width=305,height=390)
